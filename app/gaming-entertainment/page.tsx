...
import { GAMING_DATA, FAQS_DATA, REVIEWS_DATA } from '@/data/layover-data';
import {
  Gamepad2,
  MapPin,
  Star,
...
export default function GamingEntertainmentPage() {
  ...
  return (
    <div className="min-h-screen pb-24 bg-[#F8FAFC] text-[#0F172A]">
      ...
      {/* HERO SECTION */}
      <section className="relative bg-gradient-to-br from-fuchsia-950 via-slate-900 to-indigo-950 text-white pt-16 pb-16 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            
            <div className="lg:col-span-7 space-y-6">
              <nav className="flex items-center gap-2 text-xs text-fuchsia-200" aria-label="Breadcrumb">
                <Link href="/" className="hover:text-white transition-colors">Home</Link>
                <span className="text-fuchsia-400">/</span>
                <span className="text-white font-medium">Gaming & Fun</span>
              </nav>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-tight">
                Airport Lounges & Gaming <br />
                <span className="text-fuchsia-400">Esports Arenas</span>
              </h1>

              <p className="text-slate-200 text-base sm:text-lg leading-relaxed max-w-2xl">
                Stay entertained during your transit with PS5 Pro gaming stations, VR simulators, bowling, and quiet executive lounges near Mumbai CSMIA.
              </p>

              <div className="grid grid-cols-2 gap-4 pt-2">
                <div className="flex items-center gap-2.5">
                  <span className="w-2.5 h-2.5 rounded-full bg-fuchsia-400"></span>
                  <span className="text-xs sm:text-sm font-semibold text-slate-200">PS5 Pro Consoles & 4K Displays</span>
                </div>
                <div className="flex items-center gap-2.5">
                  <span className="w-2.5 h-2.5 rounded-full bg-fuchsia-400"></span>
                  <span className="text-xs sm:text-sm font-semibold text-slate-200">Executive Recliner Lounges</span>
                </div>
                <div className="flex items-center gap-2.5">
                  <span className="w-2.5 h-2.5 rounded-full bg-fuchsia-400"></span>
                  <span className="text-xs sm:text-sm font-semibold text-slate-200">Complimentary Food & Wi-Fi</span>
                </div>
                <div className="flex items-center gap-2.5">
                  <span className="w-2.5 h-2.5 rounded-full bg-fuchsia-400"></span>
                  <span className="text-xs sm:text-sm font-semibold text-slate-200">Inside T2 & Nearby Hubs</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-white/10 aspect-[4/3]">
                ...
                <div className="absolute bottom-4 left-4 bg-slate-900/80 backdrop-blur-md px-3.5 py-2 rounded-xl text-xs text-white font-bold flex items-center gap-2 border border-white/10">
                  <MapPin size={14} className="text-fuchsia-400" /> CSMIA Esports Hub
                </div>
              </div>
            </div>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="flex items-center justify-between border-b border-slate-200 pb-4">
            <h2 className="text-xl font-bold text-slate-900">Gaming Stations & Lounges</h2>
            <span className="text-xs text-slate-500 font-bold">{GAMING_DATA.length} Available Arenas</span>
          </div>
              ...
              >
                <div>
                  <div className="relative h-60 w-full">
                    ...
                    {item.badge && (
                      <span className="absolute top-4 left-4 bg-fuchsia-700 text-white text-xs font-black uppercase tracking-wider px-2.5 py-1 rounded-md shadow-md">
                        {item.badge}
                      </span>
                    )}
                  ...
                  <div className="p-6 space-y-4">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 flex items-center gap-1.5">
                        <MapPin size={14} className="text-[#0369a1]" /> {item.location} ({item.distance})
                      </p>
                    </div>
      ...
      <section className="py-16 bg-white border-t border-slate-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="text-center">
            ...
            <h2 className="text-3xl font-extrabold text-slate-900">Gaming & Lounges FAQ</h2>
          </div>
