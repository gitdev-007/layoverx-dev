        ...
        if (data && data.length > 0) {
          ...
          if (hotelPods.length > 0) {
            setHotelsList(hotelPods.map((item: any) => ({
              ...
              transitTime: item.transitTime || (item.distance?.includes('0 km') ? '0 min walk (Inside T2)' : '5–10 mins taxi'),
              ...
              image: item.image || item.imageUrl || 'https://images.unsplash.com/photo-1590490360182-c33d57733427?auto=format&fit=crop&w=800&q=80',
            })));
          }
          ...
          if (spas.length > 0) {
            setSpasList(spas.map((item: any) => ({
              ...
              distance: item.distance || '0 km',
              transitTime: item.transitTime || '0 min walk (Inside T2)',
          ...
          if (tours.length > 0) {
            setToursList(tours.map((item: any) => ({
              ...
              transitTime: item.transitTime || '40–60 mins taxi',
