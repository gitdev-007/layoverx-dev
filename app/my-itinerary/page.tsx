                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-3 gap-4 text-xs font-bold text-slate-700">
                    <div className="bg-slate-50 p-3 rounded-2xl border border-slate-100">
                      ...
                      <strong className="text-sm font-extrabold text-slate-900">8.0 Hours</strong>
                    </div>
                    <div className="bg-sky-50 p-3 rounded-2xl border border-sky-100">
                      ...
                      <strong className="text-sm font-extrabold text-[#0369a1]">4.5 Hours</strong>
                    </div>
                    <div className="bg-indigo-50 p-3 rounded-2xl border border-indigo-100">
                      <span className="text-indigo-600 block text-[10px] uppercase tracking-wider mb-0.5">Remaining Window</span>
                      <strong className="text-sm font-extrabold text-indigo-900">3.5 Hours</strong>
                    </div>
                  </div>

                  <div className="relative w-full h-3.5 bg-slate-100 rounded-full overflow-hidden flex border border-slate-200">
                    <div className="h-full bg-[#0369a1] transition-all duration-500 w-[55%]"></div>
                    <div className="h-full bg-slate-300 transition-all duration-500 w-[45%]"></div>
                  </div>
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-white rounded-3xl border border-slate-200 p-6 sm:p-8 shadow-md space-y-6">
                ...
                <div className="border-t border-slate-100 pt-4 flex justify-between items-baseline">
                  ...
                  <span className="text-2xl sm:text-3xl font-black text-[#0369a1]">₹4,798</span>
                </div>
