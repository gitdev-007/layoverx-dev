...
export const HOTELS_DATA: Hotel[] = [
  ...
  },
  {
    ...
    description: '5-star luxury located 5 minutes from Terminal 2 with 24/7 chauffeured airport transfers on request. Features expansive day-use suites, resort lagoon pool, and 24-hour dining.',
  ...
  },
  {
    ...
    distance: '4.5 km from T2 / 0.8 km from T1',
    ...
    badge: 'Eco 5-Star',
    amenities: [
      'Free Domestic T1 Shuttle',
      'Rooftop Runway-View Pool',
      'Soundproof Double Glazing',
      '24/7 Multi-Cuisine Coffee Shop',
      'Hourly Day Packages',
    ],
    description: "Asia's first certified 5-star Ecotel, located right along the airport corridor. Features a rooftop swimming pool overlooking the CSMIA runway, soundproof rooms, and complimentary Domestic T1 airport shuttles.",
